...
- [**QuickCapture v2**](https://github.com/ExtrieveTechnologies/QuickCapture_Android#document-scanning-capture-sdk-android-v2): With **most** functionality, designed to be as compact as possible. [~ **2 MB**]
- [**QuickCapture v3**](https://github.com/ExtrieveTechnologies/QuickCapture_Android#document-scanning-capture-sdk-android-v3): Comprehensive & advanced **AI** functionality, but **comparatively bit** larger in size. [~ **20 MB**]
