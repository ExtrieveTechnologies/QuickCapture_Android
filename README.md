...
- [**QuickCapture v3**](https://github.com/ExtrieveTechnologies/QuickCapture_Android/tree/QuickCapture-V3): SDK with comprehensive and advanced **AI** functionality, but **comparatively bit** larger in size. [Arround **20 MB**]
