...
- [**QuickCapture v3**](https://github.com/ExtrieveTechnologies/QuickCapture_Android/tree/QuickCapture-V3#document-scanning-capture-sdk-android-v3): With Comprehensive & advanced **AI** functionalities, but **comparatively bit** larger size. [~ **20 MB**]
